...
public class Result__1 {
    ...
    @SerializedName("task_effective_number")
    @Expose
    ...
    @Expose
    private SysDomain__1 sysDomain;
    @SerializedName("state")
    @Expose
    private String state;
    @SerializedName("route_reason")
    @Expose
    ...
    @SerializedName("universal_request")
    @Expose
    ...
    public OpenedBy__1 getOpenedBy() {
        return openedBy;
    }

    public void setOpenedBy(OpenedBy__1 openedBy) {
    ...
    public SysDomain__1 getSysDomain() {
        return sysDomain;
    }

    public void setSysDomain(SysDomain__1 sysDomain) {
